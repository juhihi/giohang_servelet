		...
		<header class="bg-dark py-5">
			<div class="container px-4 px-lg-5 my-5">
				<div class="text-center text-white">
					<a href="/ASM/index"><h1 class="display-4 fw-bolder">Shop
							in style</h1></a>
	...
	<div id="wrapper" class="container">
							...
							<li class="span3">
								<div class="product-box">
									<span class="sale_tag"></span> <a
										href="<c:url value='/sanpham?maSP=${product.masp}' />"><img
										alt=""
										src="<c:url value='home/themes/images/hinhanh/${product.hinh}' />"></a><br />
									<a href="<c:url value='/sanpham?maSP=${product.masp}' />"
										class="title">${product.tensp}</a><br /> <a href="#"
										class="category">${product.mota}</a>
									<p class="price">
										<img srs="">
		...
		<section id="footer-bar">
			<div class="row">
				...
				<div class="span12">
					<h4 class="text-center">PS22736_Nguyễn Tấn Tàiss</h4>
				</div>
			</div>
		</section>
